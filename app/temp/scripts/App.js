...
class Adult extends __WEBPACK_IMPORTED_MODULE_1__modules_Person__["a" /* default */]{
	payTaxes(){
		console.log(this.name + "now owes $0 in taxes.");
	}
}

var johny = new __WEBPACK_IMPORTED_MODULE_1__modules_Person__["a" /* default */]("John Doe", "blue");
johny.greet();
